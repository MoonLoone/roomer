...
fun NavGraphBuilder.homeGraph(navController: NavHostController) {
    navigation(
        ...
        composable(
            Screens.SearchRoomResults.name + "?from={from}&to={to}&location={location}&bedrooms={bedrooms}&bathrooms={bathrooms}&apartment_type={apartment_type}"
        ) {
