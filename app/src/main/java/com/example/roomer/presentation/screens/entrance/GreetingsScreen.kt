...
fun StartScreen(
    ...
    Column(
        ...
        GreenButtonPrimary(
            ...
            navigator.navigate(LoginScreenDestination(Constants.ScreensId.greetingScreenId))
        }
        GreenButtonOutline(
            text = "Sign Up",
            modifier = Modifier
            ...
            navigator.navigate(SignUpScreen1Destination(Constants.ScreensId.greetingScreenId))
        }
    }
}
